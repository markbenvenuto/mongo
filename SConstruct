...
add_option('use-system-libsodium',
    help='use system version of libsodium library',
    nargs=0,
)
...
def doConfigure(myenv):
    ...
    if use_system_version_of_library("libsodium"):
        conf.FindSysLibDep("libsodium", "libsodium")
