...
public:
     ...
     */
    static std::string generateClientFirst(std::vector<char>* clientNonce);

    /**
     * Parse server first message and generate client second.
     */
    static std::string generateClientSecond(StringData serverFirst,
                                            const std::vector<char>& clientNonce,
                                            const AWSCredentials& credentials);

private:
    static std::vector<char> generateClientNonce();
};

class SaslIAMClientProtocolUtil {
public:
    /**
     ...
     */
    static std::string parseRoleFromEC2IamSecurityCredentials(StringData data);
     ...
     * first                  us-east-1
     */
    static std::string getRegionFromHost(StringData host);
     ...
     * }
     */
    static AWSCredentials parseCredentialsFromEC2IamSecurityCredentials(StringData data);
     ...
     * }
     */
    static AWSCredentials parseCredentialsFromECSTaskIamCredentials(StringData data);
};
