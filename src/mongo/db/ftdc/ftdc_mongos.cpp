...
// Tests
// Start up mongos without logfile
// with log file
// with syslog
// with explict ftdc path
void startMongoSFTDC() {
    ...
    // Only attempt to enable FTDC if we have a path to log to
    bool enableFTDC = true;
    ...
    startFTDC(directory, enableFTDC, registerMongoSCollectors);
}
