...
public:
     ...
     *
     * Returns ErrorCodes::FTDCPathNotSet if not log path has been specified for FTDC. This occurs
     * in MongoS in some
     * situations since mongos is not required to have a storage directory like MongoD does.
     */
