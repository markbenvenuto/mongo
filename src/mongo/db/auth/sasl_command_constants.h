...
/// Field containing accessKey information for MONGODB-IAM sasl mechanism.
constexpr auto saslCommandIamAccessKey = "iamAccessKey"_sd;

/// Field containing accessKey information for MONGODB-IAM sasl mechanism.
constexpr auto saslCommandIamSecretKey = "iamSecretKey"_sd;
