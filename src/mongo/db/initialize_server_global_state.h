...
/**
 * Enum which controllers whether the pid file is written at startup.
 */
 ...
 */
bool initializeServerGlobalState(ServiceContext* service, PidFileWrite pidWrite = PidFileWrite::Write);
