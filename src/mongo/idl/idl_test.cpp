...
TEST(IDLArrayTests, TestArraysOfComplexTypes) {
    ...
    assert_same_types<decltype(testStruct.getField5()), const std::vector<mongo::One_string>&>();
    ...
    ASSERT_EQUALS(testStruct.getField5().size(), 2);
    ASSERT_EQUALS(testStruct.getField5()[0].getValue(), "hello");
    ASSERT_EQUALS(testStruct.getField5()[1].getValue(), "world");
    ASSERT_EQUALS(testStruct.getField5o().get().size(), 2);
    ASSERT_EQUALS(testStruct.getField5o().get()[0].getValue(), "goodbye");
    ASSERT_EQUALS(testStruct.getField5o().get()[1].getValue(), "world");
}
