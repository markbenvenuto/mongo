...
TEST(IDLFieldTests, TestOptionalFields) {
    ...
    // Positive: Test document with only string field
    {
        ...
        MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField2()),
                                         const boost::optional<std::int32_t>>::value);
        MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField1()),
...
TEST(IDLNestedStruct, TestDuplicatTypes) {
    ...
    MONGO_STATIC_ASSERT(
        std::is_same<decltype(testStruct.getField1()), const RequiredStrictField3&>::value);
    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField2()),
                                     const boost::optional<RequiredNonStrictField3>>::value);
    MONGO_STATIC_ASSERT(
        std::is_same<decltype(testStruct.getField3()), const RequiredStrictField3&>::value);
...
TEST(IDLArrayTests, TestSimpleArrays) {
    ...
    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField1()),
                                     const std::vector<mongo::StringData>>::value);
    MONGO_STATIC_ASSERT(
        std::is_same<decltype(testStruct.getField2()), const std::vector<std::int32_t>&>::value);
    MONGO_STATIC_ASSERT(
        std::is_same<decltype(testStruct.getField3()), const std::vector<double>&>::value);
...
TEST(IDLArrayTests, TestSimpleOptionalArrays) {
    ...
    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField1()),
                                     const boost::optional<std::vector<mongo::StringData>>>::value);
    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField2()),
                                     const boost::optional<std::vector<std::int32_t>>>::value);
    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField3()),
...
TEST(IDLArrayTests, TestArraysOfComplexTypes) {
    ...
    MONGO_STATIC_ASSERT(
        std::is_same<decltype(testStruct.getField1()), const std::vector<std::int64_t>&>::value);
    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField2()),
                                     const std::vector<mongo::NamespaceString>&>::value);
    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField3()),
                                     const std::vector<mongo::AnyBasicType>&>::value);
    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField4()),
                                     const std::vector<mongo::ObjectBasicType>&>::value);

    MONGO_STATIC_ASSERT(std::is_same<decltype(testStruct.getField1o()),
                                     const boost::optional<std::vector<std::int64_t>>>::value);
    MONGO_STATIC_ASSERT(
        std::is_same<decltype(testStruct.getField2o()),
                     const boost::optional<std::vector<mongo::NamespaceString>>>::value);
    MONGO_STATIC_ASSERT(
        std::is_same<decltype(testStruct.getField3o()),
                     const boost::optional<std::vector<mongo::AnyBasicType>>>::value);
    MONGO_STATIC_ASSERT(
        std::is_same<decltype(testStruct.getField4o()),
                     const boost::optional<std::vector<mongo::ObjectBasicType>>>::value);
