 ...
 * synchronized_value. Do not use this class directly.
 *
...
class synchronized_value {
    friend class details::update_guard<T>;
...
public:
    ...
    const details::update_guard<T> operator*() const {
        return details::update_guard<T>(_value, _mutex);
    }
    ...
    bool operator==(synchronized_value const& rhs) const {
        ...
        stdx::lock_guard<stdx::mutex> lk1(_mutex, std::adopt_lock);
        stdx::lock_guard<stdx::mutex> lk2(rhs._mutex, std::adopt_lock);
...
bool operator==(const synchronized_value<T>& lhs, const synchronized_value<T>& rhs) {
    ...
    stdx::lock_guard<stdx::mutex> lk1(lhs._mutex, std::adopt_lock);
    stdx::lock_guard<stdx::mutex> lk2(rhs._mutex, std::adopt_lock);
