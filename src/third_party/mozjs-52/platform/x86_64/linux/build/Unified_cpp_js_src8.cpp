...
#undef INITGUID
#endif
#include "jit/BaselineCacheIR.cpp"
#ifdef PL_ARENA_CONST_ALIGN_MASK
#error "jit/BaselineCacheIR.cpp uses PL_ARENA_CONST_ALIGN_MASK, so it cannot be built in unified mode."
#undef PL_ARENA_CONST_ALIGN_MASK
#endif
#ifdef INITGUID
#error "jit/BaselineCacheIR.cpp defines INITGUID, so it cannot be built in unified mode."
#undef INITGUID
#endif
