...
class ParserError(common.SourceLocation):
    ...
    - file_name - a IDL file which contained the EOFError.
...
class ParserContext(object):
    ...
    def _add_error(self, location, error_id, msg):
        ...
        This is usually directly from a idl.syntax or idl.ast class.
        """
    ...
    def add_not_custom_scalar_serialization_not_supported(self, location, ast_type, ast_parent,
                                                          bson_type_name):
        # type: (common.SourceLocation, unicode, unicode, unicode) -> None
        # pylint: disable=invalid-name
        """Add an error about field must be empty for fields of type struct."""
