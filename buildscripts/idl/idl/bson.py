...
BSON_TYPE_INFORMATION = { 
    ...
    "double" : { 'scalar' :  True, 'cpp_type' : 'NumberDouble'},
    "string" : { 'scalar' :  True, 'cpp_type' : 'String'},
    "object" : { 'scalar' :  False, 'cpp_type' : 'Object'},
    #"array" : { 'scalar' :  False, 'cpp_type' : 'Array'},
    "bindata" : { 'scalar' :  True, 'cpp_type' : 'BinData'},
    "undefined" : { 'scalar' :  True, 'cpp_type' : 'Undefined'},
    "objectid" : { 'scalar' :  True, 'cpp_type' : 'jstOID'},
    "bool" : { 'scalar' :  True, 'cpp_type' : 'Bool'},
    "date" : { 'scalar' :  True, 'cpp_type' : 'Date'},
    "null" : { 'scalar' :  True, 'cpp_type' : 'jstNULL'},
    "regex" : { 'scalar' :  True, 'cpp_type' : 'RegEx'},
    ...
    "int" : { 'scalar' :  True, 'cpp_type' : 'NumberInt'},
    "timestamp" : { 'scalar' :  True, 'cpp_type' : 'bsonTimestamp'},
    "long" : { 'scalar' :  True, 'cpp_type' : 'NumberLong'},
    "decimal" : { 'scalar' :  True, 'cpp_type' : 'NumberDecimal'},
...
BINDATA_SUBTYPE = {
    "generic" : { 'scalar' :  True, 'cpp_type' : 'BinDataGeneral'},
    "function" : { 'scalar' :  True, 'cpp_type' : 'Function'},
    "binary" : { 'scalar' :  False, 'cpp_type' : 'ByteArrayDeprecated'},
    "uuid_old" : { 'scalar' :  False, 'cpp_type' : 'bdtUUID'},
    "uuid" : { 'scalar' :  True, 'cpp_type' : 'newUUID'},
    "md5" : { 'scalar' :  True, 'cpp_type' : 'MD5Type'},
    # "user_defined" : True
}
