...
class EnumTypeInfoBase(object):
    ...
    @abstractmethod
    def get_cpp_value(self, enum_value):
...
class _EnumTypeInt(EnumTypeInfoBase):
    ...
    def __init__(self, idlenum):
        # type: (Union[syntax.Enum,ast.Enum]) -> None
        super(_EnumTypeInt, self).__init__(idlenum)
...
class _EnumTypeString(EnumTypeInfoBase):
    ...
    def __init__(self, idlenum):
        # type: (Union[syntax.Enum,ast.Enum]) -> None
        super(_EnumTypeString, self).__init__(idlenum)
...
def get_type_info(idlenum):
    ...
    if idlenum.type == 'int':
        return _EnumTypeInt(idlenum)
    elif idlenum.type == 'string':
        return _EnumTypeString(idlenum)
