...
def _get_field_member_type(field):
    ...
    return _get_field_parameter_type(field)
...
class _IndentedTextWriter(object):
    ...
    def write_line(self, msg):
        ...
        fill = ''
        for _ in range(self._indent * _INDENT_SPACE_COUNT):
            fill += ' '
...
class _CppHeaderFileWriter(_CppFileWriterBase):
    ...
    def gen_getter(self, field):
        ...
        #self._writer.write_line("%s get%s() && = delete" %
        #                                (param_type, _camel_case(field.name)))
